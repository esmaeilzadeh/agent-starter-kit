...
Do not put slugs in `.agents/ask/stages/*.md` or in `models.defaults.yaml`.
...
3. Consumer overlay `.agents/ask.local/bindings/models.yaml` or `_ask/bindings/models.yaml` (optional; upgrade must not clobber it)
