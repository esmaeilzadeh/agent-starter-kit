...
6. **Default path (guidance, not a lock):** follow the kit stages. If the human skips ahead, **warn once** (what was skipped, risk, how to rejoin) and follow their way — see `_ask/policies/workflow.md`. Read `_ask/policies/` (`delegation.md`, `risk.md`, `verification.md`, `worktree.md`, `workflow.md`).
