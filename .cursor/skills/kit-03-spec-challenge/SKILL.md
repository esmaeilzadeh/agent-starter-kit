...
description: Kit protocol stage 03-spec-challenge. Generated from part-engineering/agents/03-spec-challenge.md
---
...
Output: `part-engineering/templates/spec-challenge.md` instance under the workstream.
