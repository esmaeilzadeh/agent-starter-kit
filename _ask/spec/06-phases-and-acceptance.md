...
|---|---|
| Explore / wayfinding / R&D on-ramp | `.agents/ask/stages/00-explore.md`, `explore-map` template, Explore skills in manifest |
| What / Why | `work/<work-id>/intent.md` |
| Intent Grilling | `.agents/ask/stages/01-grill.md` |
| OpenSpec / Specification | `.agents/ask/stages/02-spec.md`, `specs/` |
| Specification Challenge | `.agents/ask/stages/03-spec-challenge.md` |
| Specification Change | `.agents/ask/stages/04-spec-change.md` |
| Planning | `.agents/ask/stages/05-plan.md` |
| Delegated implementation | `.agents/ask/stages/06-implement.md` |
| Structured review | `.agents/ask/stages/07-review.md` |
| Delegated refactor | `.agents/ask/stages/08-refactor.md` |
| Verification | `.agents/ask/stages/09-verify.md`, `./ask verify` |
| Acceptance | `.agents/ask/stages/10-accept.md`, `acceptance.md` |
...
| Humanizer on human-facing docs; writing-for-agents on machine-first files | `_ask/skills/manifest.yaml` (`humanizer`, `writing-for-agents`), `.cursor/rules/humanizer-docs-specs.mdc`, `.cursor/rules/writing-for-agents-machine-docs.mdc`, ADR 0017 |
| Load-bearing grilling + skill-before-grill | `.agents/ask/stages/01-grill.md`, ADR 0016 |
...
| Git-flow | `_ask/policies/git-flow.md`, `./ask start-work` from `develop` |
...
| Cursor Binding sync | `./ask sync` (reads `.agents/ask/`), `.cursor/` |
